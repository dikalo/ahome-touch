...
import com.ait.toolkit.sencha.touch.client.core.handlers.tabitem.TabItemChangeEvent;
    ...
    public void add(Widget w) {
        if (!(w instanceof TabItem)) {
            throw new IllegalStateException(
                            "TabPanel can only contain a child of type com.ait.toolkit.sencha.touch.client.ui.TabItem ");
        }
        add((TabItem) w);
    }
