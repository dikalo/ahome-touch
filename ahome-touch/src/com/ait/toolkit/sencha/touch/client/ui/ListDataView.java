...
public class ListDataView extends DataView implements ListElement,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ait.toolkit.sencha.touch.client.dataview.ListElement#isGrouped()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.ait.toolkit.sencha.touch.client.dataview.ListElement#setGrouped(boolean
	 * )
	 */
	 ...
	 * 
	 * @see
	 * com.ait.toolkit.sencha.touch.client.dataview.ListElement#hasIndexBar()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.ait.toolkit.sencha.touch.client.dataview.ListElement#setIndexBar(
	 * boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.ait.toolkit.sencha.touch.client.dataview.ListElement#setPinHeaders
	 * (boolean)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ait.toolkit.sencha.touch.client.dataview.ListElement#
	 ...
	 * 
	 * @see
	 * com.ait.toolkit.sencha.touch.client.ui.ListElement#setOnItemDisclosure
	 * (com
	 * .ait.toolkit.sencha.touch.client.core.handlers.list.ItemDisclosureHandler
	 * )
	 */
	@Override
		...
		if (value == true) {
			...
			this.addItemTapHandler(new DataViewItemTapHandler() {
				...
				public void onItemTap(DataView dataView, int index,
						Element element, BaseModel record,
			...
			this.addItemTouchStartHandler(new DataViewItemTouchStartHandler() {
				@Override
				public void onItemTouchStart(DataView dataView, int index,
						SimpleListItem element, BaseModel record,
