...
public abstract class SpinnerSpinDownHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SpinnerSpinDownHandler listener) /*-{
		return function(source, value, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.spinner.SpinnerSpinDownHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Spinner;DLjava/lang/Object;)(spinner, value, eOpts);
		};
    }-*/;
