...
public abstract class DisableHandler extends AbstractHandler {

  final JavaScriptObject jsoPeer = createPeer(this);

  private static native JavaScriptObject createPeer(DisableHandler listener) /*-{
		return function(c) {
			var comp = @com.ait.toolkit.sencha.touch.client.core.Component::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.DisableHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
  }-*/;
  ...
  public abstract void onDisable(Component comp);
}
