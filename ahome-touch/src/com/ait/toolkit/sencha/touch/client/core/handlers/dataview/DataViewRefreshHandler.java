...
public abstract class DataViewRefreshHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DataViewRefreshHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.dataview.DataViewRefreshHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/DataView;Ljava/lang/Object;)(dataView, eOpts);
		};
    }-*/;
