...
public abstract class MapTypeChangeHandler extends AbstractHandler {
	  ...
	  private static native JavaScriptObject createPeer(MapTypeChangeHandler listener) /*-{
			return function(source, googlemap, maptype) {
				var map = @com.ait.toolkit.sencha.touch.client.ui.GoogleMap::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
				listener.@com.ait.toolkit.sencha.touch.client.core.handlers.map.MapTypeChangeHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/GoogleMap;Lcom/google/gwt/core/client/JavaScriptObject;D)(map,googlemap,maptype);
			};
	  }-*/;
