...
public abstract class BeforeHideHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(BeforeHideHandler listener) /*-{
		return function(c) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.BeforeHideHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
  }-*/;
