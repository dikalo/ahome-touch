...
public abstract class NavigationViewPopHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(NavigationViewPopHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.navigation.NavigationViewPopHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/NavigationView;Ljava/lang/Object;)(source,eOpts);
		};
    }-*/;
