...
public abstract class BeforeRenderHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(BeforeRenderHandler listener) /*-{
		return function(c) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.BeforeRenderHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
  }-*/;
