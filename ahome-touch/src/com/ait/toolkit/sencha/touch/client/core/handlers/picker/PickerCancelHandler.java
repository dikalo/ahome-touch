...
public abstract class PickerCancelHandler extends AbstractHandler {
	...
	private static native JavaScriptObject createPeer(
		...
		return function(source, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.picker.PickerCancelHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Picker;Ljava/lang/Object;)(picker, eOpts);
		};
	}-*/;
	...
	private void fireOnEventAndCatch(Picker picker, Object eOpts,
