...
public abstract class ShowHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ShowHandler listener) /*-{
		return function(source, eOpts) {
			var comp = @com.ait.toolkit.sencha.touch.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.ShowHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;Ljava/lang/Object;)(comp, eOpts);
		};
    }-*/;
