...
public abstract class HeightChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(HeightChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.HeightChangeHandler::onHeightChange(Lcom/ait/toolkit/sencha/touch/client/core/Component;DDLjava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
