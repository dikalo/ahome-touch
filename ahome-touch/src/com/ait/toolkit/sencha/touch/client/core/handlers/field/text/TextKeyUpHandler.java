...
public abstract class TextKeyUpHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextKeyUpHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.text.TextKeyUpHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Text;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/Object;)(textField, eventObject, eOpts);
		};
    }-*/;
