...
public abstract class DataViewItemsMapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DataViewItemsMapHandler listener) /*-{
		return function(source, index, element, eventObject, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.dataview.DataViewItemsMapHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/DataView;DLcom/google/gwt/dom/client/Element;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/Object;)(dataView, index, element, eventObject, eOpts);
		};
    }-*/;
