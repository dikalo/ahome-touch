...
public abstract class DataViewDoSelectHandler extends AbstractHandler {
	...
	private static native JavaScriptObject createPeer(
			DataViewDoSelectHandler listener) /*-{
		return function(source, record, supressed, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.dataview.DataViewDoSelectHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/DataView;Lcom/ait/toolkit/data/client/BaseModel;Ljava/lang/Boolean;Ljava/lang/Object;)(dataView,model, supressed, eOpts);
		};
	}-*/;

	// Called from JSNI
	private final void fireOnEvent(DataView dataView, BaseModel record,
			Boolean supressed, Object eOpts) {
	...
	private void fireOnEventAndCatch(DataView dataView, BaseModel record,
			Boolean supressed, Object eOpts, UncaughtExceptionHandler handler) {
		try {
			onDoSelect(dataView, record, supressed, eOpts);
		} catch (Throwable e) {
	...
	public abstract void onDoSelect(DataView dataView, BaseModel record,
			Boolean supressed, Object eOpts);
