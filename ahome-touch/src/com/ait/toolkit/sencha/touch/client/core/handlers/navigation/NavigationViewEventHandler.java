...
public abstract class NavigationViewEventHandler extends AbstractHandler {
	...
	private static native JavaScriptObject createPeer(
			NavigationViewEventHandler listener) /*-{
		return function(view, eOpts) {
			var navView = @com.ait.toolkit.sencha.touch.client.ui.NavigationView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(view);
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.navigation.NavigationViewEventHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/NavigationView;Ljava/lang/Object;)(view,eOpts);
		};
	}-*/;
	...
	private void fireOnEventAndCatch(NavigationView view, Object eOpts,
