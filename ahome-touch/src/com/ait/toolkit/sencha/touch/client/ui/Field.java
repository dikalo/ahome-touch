...
/**
 * Field is the base class for all form fields used in Sencha Touch. It provides a lot of shared functionality to all field subclasses (for example labels, simple validation,
 * clearing and tab index management), but is rarely used directly. Instead, it is much more common to use one of the field subclasses:
 * 
 * xtype Class --------------------------------------- textfield Ext.field.Text numberfield Ext.field.Number textareafield Ext.field.TextArea hiddenfield Ext.field.Hidden
 * radiofield Ext.field.Radio checkboxfield Ext.field.Checkbox selectfield Ext.field.Select togglefield Ext.field.Toggle fieldset Ext.field.FieldSet Fields are normally used within
 * the context of a form and/or fieldset. See the FormPanel and FieldSet docs for examples on how to put those together, or the list of links above for usage of individual field
 * types. If you wish to create your own Field subclasses you can extend this class, though it is sometimes more useful to extend Ext.field.Text as this provides additional text
 * entry functionality.
 * 
 */
