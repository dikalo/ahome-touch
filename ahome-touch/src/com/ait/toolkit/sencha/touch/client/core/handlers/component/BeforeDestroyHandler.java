...
public abstract class BeforeDestroyHandler extends AbstractHandler {

  final JavaScriptObject jsoPeer = createPeer(this);

  private static native JavaScriptObject createPeer(BeforeDestroyHandler listener) /*-{
		return function(c) {
			var comp = @com.ait.toolkit.sencha.touch.client.core.Component::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.BeforeDestroyHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
  }-*/;
  ...
  public abstract void onBeforeDestroy(Component comp);
}
