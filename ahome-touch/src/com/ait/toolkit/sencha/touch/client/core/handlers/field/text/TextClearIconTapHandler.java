...
public abstract class TextClearIconTapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextClearIconTapHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.text.TextClearIconTapHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Text;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/Object;)(textField, eventObject, eOpts);
		};
    }-*/;
