...
public abstract class BeforeSubmitFormHandler extends AbstractHandler {
	...
	private static native JavaScriptObject createPeer(
			BeforeSubmitFormHandler listener) /*-{
		return function(source, values, options, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.form.BeforeSubmitFormHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/FormPanel;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(form, values, options, eOpts);
		};
	}-*/;

	// Called from JSNI
	private final void fireOnEvent(FormPanel panel, Object values,
	...
	private void fireOnEventAndCatch(FormPanel panel, Object values,
			Object options, Object eOpts, UncaughtExceptionHandler handler) {
		try {
			onBeforeSubmit(panel, values, options, eOpts);
		} catch (Throwable e) {
	...
	public abstract void onBeforeSubmit(FormPanel panel, Object values,
			Object options, Object eOpts);
