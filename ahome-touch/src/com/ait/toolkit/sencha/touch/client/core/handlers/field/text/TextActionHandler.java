...
public abstract class TextActionHandler extends AbstractHandler {

    final JavaScriptObject jsoPeer = createPeer(this);

    private static native JavaScriptObject createPeer(TextActionHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.text.TextActionHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Text;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/Object;)(textField, event, eOpts);
		};
    }-*/;
    ...
    public abstract void onAction(Text<String> text, JavaScriptObject event, Object eOpts);
