...
public abstract class DataViewItemSwipeHandler extends AbstractHandler {

    final JavaScriptObject jsoPeer = createPeer(this);

    private static native JavaScriptObject createPeer(DataViewItemSwipeHandler listener) /*-{
		return function(source, index, element, eventObject, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.dataview.DataViewItemSwipeHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/DataView;DLcom/google/gwt/dom/client/Element;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/Object;)(dataView, index, element, eventObject, eOpts);
		};
    }-*/;
    ...
    private final void fireOnEvent(DataView dataView, double index, Element element, EventObject eventObject,
        ...
        if (handler != null) {
            ...
            onItemSwipe(dataView, index, element, eventObject, eOpts);
        }
    }
    ...
    public abstract void onItemSwipe(DataView dataView, double index, Element element, EventObject eventObject,
                    Object eOpts);
