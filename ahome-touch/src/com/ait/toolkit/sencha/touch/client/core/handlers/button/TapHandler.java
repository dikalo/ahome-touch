...
public abstract class TapHandler extends AbstractHandler {

	final JavaScriptObject jsoPeer = createPeer(this);

	private static native JavaScriptObject createPeer(TapHandler listener) /*-{
		return function(source, event) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.button.TapHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Button;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;)(btn,e);
		};
	}-*/;
	...
	public abstract void onTap(Button button, EventObject event);
}
