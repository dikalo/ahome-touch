...
public abstract class ActivateHandler extends AbstractHandler {
	...
	private static native JavaScriptObject createPeer(ActivateHandler listener) /*-{
		return function(c) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.ActivateHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
	}-*/;
	...
	private void fireOnEventAndCatch(Component comp,
