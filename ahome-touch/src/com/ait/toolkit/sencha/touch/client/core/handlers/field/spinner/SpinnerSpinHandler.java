...
public abstract class SpinnerSpinHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SpinnerSpinHandler listener) /*-{
		return function(source, value, direction, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.spinner.SpinnerSpinHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Spinner;DLjava/lang/String;Ljava/lang/Object;)(spinner, value, direction, eOpts);
		};
    }-*/;
