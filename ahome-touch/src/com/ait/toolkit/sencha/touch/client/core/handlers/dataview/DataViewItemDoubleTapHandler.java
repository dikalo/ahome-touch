...
public abstract class DataViewItemDoubleTapHandler extends AbstractHandler {
	...
	private static native JavaScriptObject createPeer(
			DataViewItemDoubleTapHandler listener) /*-{
		return function(source, index, element, eventObject, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.dataview.DataViewItemDoubleTapHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/DataView;DLcom/google/gwt/dom/client/Element;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/Object;)(dataView, index, element, eventObject, eOpts);
		};
	}-*/;

	// Called from JSNI
	private final void fireOnEvent(DataView dataView, double index,
			Element element, EventObject eventObject, Object eOpts) {
		UncaughtExceptionHandler handler = GWT.getUncaughtExceptionHandler();
		if (handler != null) {
			fireOnEventAndCatch(dataView, index, element, eventObject, eOpts,
					handler);
		} else {
	...
	private void fireOnEventAndCatch(DataView dataView, double index,
			Element element, EventObject eventObject, Object eOpts,
	...
	public abstract void onItemDoubleTap(DataView dataView, double index,
			Element element, EventObject eventObject, Object eOpts);
