...
public abstract class AfterRenderHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(AfterRenderHandler listener) /*-{
		return function(c) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.AfterRenderHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
  }-*/;
