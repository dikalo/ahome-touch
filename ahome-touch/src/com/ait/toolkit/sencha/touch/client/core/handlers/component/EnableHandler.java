...
public abstract class EnableHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(EnableHandler listener) /*-{
		return function(c) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.EnableHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/core/Component;)(comp);
		};
  }-*/;
