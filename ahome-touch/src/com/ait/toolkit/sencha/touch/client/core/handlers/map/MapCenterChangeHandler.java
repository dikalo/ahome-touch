...
public abstract class MapCenterChangeHandler extends AbstractHandler {
	  ...
	  private static native JavaScriptObject createPeer(MapCenterChangeHandler listener) /*-{
			return function(source, googlemap, latlgn) {
				...
				listener.@com.ait.toolkit.sencha.touch.client.core.handlers.map.MapCenterChangeHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/GoogleMap;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;)(map,googlemap, latlgn);
			};
	  }-*/;
