...
public abstract class CheckBoxCheckHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(CheckBoxCheckHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.checkbox.CheckBoxCheckHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/CheckBox;Ljava/lang/Object;)(checkBox, eOpts);
		};
    }-*/;
