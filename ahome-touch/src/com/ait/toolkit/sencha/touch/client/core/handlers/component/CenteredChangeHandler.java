...
public abstract class CenteredChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(CenteredChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.CenteredChangeHandler::onCenteredChange(Lcom/ait/toolkit/sencha/touch/client/core/Component;ZZLjava/lang/Object;)(component, existingValue, newValue, eOpts);
		};
    }-*/;
