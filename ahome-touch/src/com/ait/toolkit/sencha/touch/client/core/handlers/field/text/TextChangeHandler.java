...
public abstract class TextChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextChangeHandler listener) /*-{
		return function(source, oldValue, newValue, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.text.TextChangeHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Text;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(textField,oldValue, newValue, eOpts);
		};
    }-*/;
