...
public abstract class DockedChangeHandler extends AbstractHandler {

    final JavaScriptObject jsoPeer = createPeer(this);

    private static native JavaScriptObject createPeer(DockedChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.component.DockedChangeHandler::onDockChange(Lcom/ait/toolkit/sencha/touch/client/core/Component;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
    ...
    private void fireOnEventAndCatch(Component component, String existingValue, String newValue, Object eOpts,
