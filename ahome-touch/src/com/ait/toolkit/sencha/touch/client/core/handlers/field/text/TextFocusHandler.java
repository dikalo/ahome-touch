...
public abstract class TextFocusHandler extends AbstractHandler {

    final JavaScriptObject jsoPeer = createPeer(this);

    private static native JavaScriptObject createPeer(TextFocusHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.ait.toolkit.sencha.touch.client.core.handlers.field.text.TextFocusHandler::fireOnEvent(Lcom/ait/toolkit/sencha/touch/client/ui/Text;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/Object;)(textField, event, eOpts);
		};
    }-*/;
    ...
    public abstract void onFocus(Text<String> text, JavaScriptObject event, Object eOpts);
