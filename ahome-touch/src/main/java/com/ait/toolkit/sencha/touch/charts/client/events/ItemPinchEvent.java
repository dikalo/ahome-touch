...
public class ItemPinchEvent extends EventObject {
	...
	public ItemPinchEvent(AbstractSeries series, JavaScriptObject item, JavaScriptObject nativeEvent) {
		super(nativeEvent);
		this.series = series;
		this.item = item;
	}
	...
	protected ItemPinchEvent(JavaScriptObject jsObj) {
		super(jsObj);
	}
