 ...
 * <p>
 * Panels are, by virtue of their inheritance from com.ait.toolkit.sencha.touch.client.core.Container, capable of being configured with a layout, and containing child Components.
 * <p>
 * When either specifying child items of a Panel, or dynamically adding Components to a Panel, remember to consider how you wish the Panel to arrange those child elements, and
 * whether those child elements need to be sized using one of Gwt4Touch's built-in **layout** schemes.
 * 
 */
